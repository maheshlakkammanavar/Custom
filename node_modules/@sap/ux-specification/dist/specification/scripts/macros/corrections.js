...
exports.macrosCorrection = {
    // This is correction for a specific api.json i.e. 1.108 in this case
    'sap.fe.macros.Table': {
    ...
    'sap.fe.macros.FilterBar': {
        aggregations: [
            {
                cardinality: '0..n',
                description: '<p>Aggregate filter fields of the FilterBar building block</p>',
                linkEnabled: true,
                methods: [],
                name: 'filterFields',
                singularName: 'filterFields',
